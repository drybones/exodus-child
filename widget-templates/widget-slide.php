	...
	?>>
		...
		<div class="exodus-slide-image-container">
			...
			<?php if ($click_url) : // image is linked ?>
				<a href="<?php echo esc_url( do_shortcode( $click_url ) ); ?>"<?php if ($instance['click_new']) : ?> target="_blank" rel="noopener noreferrer"<?php endif; ?>>
			<?php endif; ?>

			<?php if ($video_url) : // video background ?>
				<video autoplay playsinline muted loop id="myVideo" width="<?php echo esc_attr( $slide_img[1] ); ?>" height="<?php echo esc_attr( $slide_img[2] ); ?>" poster="<?php echo esc_url( $slide_img[0] ); ?>">
  					<source src="<?php echo esc_url( do_shortcode( $video_url ) ); ?>" type="video/mp4">
				</video>
			<?php else : ?>
					...
					<div class="exodus-slide-caption-content">
						...
						<?php if ($instance['title']) : // title provided ?>
							...
							<?php if ($click_url) : // slide is linked ?>
								...
								<a href="<?php echo do_shortcode( $click_url ); ?>" class="exodus-slide-title"<?php if ($instance['click_new']) : ?> target="_blank" rel="noopener noreferrer"<?php endif; ?>>
						...
						<?php if ($instance['description']) : // description provided ?>
							...
							<?php if ($click_url) : // slide is linked ?>
								...
								<a href="<?php echo do_shortcode( $click_url ); ?>" class="exodus-slide-description"<?php if ($instance['click_new']) : ?> target="_blank" rel="noopener noreferrer"<?php endif; ?>>
